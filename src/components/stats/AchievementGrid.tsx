    ...
    <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl border border-white dark:border-gray-800 shadow-lg p-5">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">{unlocked} / {achievements.length} unlocked</p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-2">
        {achievements.map((a, i) => (
          ...
          >
            <span className={`text-2xl leading-none mt-0.5 ${a.unlocked ? '' : 'grayscale'}`}>
              {a.icon}
            </span>
